                        ...
                        if($row_f = mysqli_fetch_assoc($result_f)) {
                            ...
                            <div class="row out mb-5 ">
                                ...
                                if($row_f['status'] === 'arr') {
                                    ...
                                    <div class="row">
                                        <div class="col-1 p-0 m-0">
                                            <i class="fa fa-3x fa-fighter-jet mt-3"
                                                style="float: right; color: green;"></i>
                                        </div>
                                        <div class="col-10 p-0 m-0 mt-4" style="float: right;">
                                ...
                                <div class="col-md-3 col-6 order-md-2 pl-0 text-center 
                                    order-lg-2 card-dep">
                                    <p class="city fw-bold">'.$row_f['source'].'</p>
                                    <p class="stat">Scheduled Departure:</p>
                                    <p class="date fw-bold">'.$date_dep.'</p>                
                                    <p class="time fw-bold">'.$time_dep.'</p>
                                </div>        
                                <div class="col-md-3 col-6 order-md-4 pr-0 text-center 
                                    order-lg-4 card-arr" 
                                    style="float: right;">
                                    <p class="city fw-bold">'.$row_f['destination'].'</p>
                                    <p class="stat">Scheduled Arrival:</p>
                                    <p class="date fw-bold">'.$date_arr.'</p>                
                                    <p class="time fw-bold">'.$time_arr.'</p>          
                                </div>
